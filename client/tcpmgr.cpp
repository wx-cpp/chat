...
{
    //auto self = shared_from_this();//类没构造完
    _handlers.insert(ID_CHAT_LOGIN_RSP, [this](ReqId id, int len, QByteArray data){
        ...
        UserMgr::get_instance()->SetUid(jsonObj["uid"].toInt());
        UserMgr::get_instance()->SetName(jsonObj["name"].toString());
        UserMgr::get_instance()->SetToken(jsonObj["token"].toString());
