    ...
    ui(new Ui::ResetDialog)
{
    ...
    //连接reset相关信号和注册处理回调
    initHandlers();
    connect(http_mgr::get_instance().get(),&http_mgr::sig_reset_mod_finish, this,
...
void ResetDialog::on_varify_btn_clicked()
{
    ...
    http_mgr::get_instance()->post_httpreq(QUrl(gate_url_prefix+"/get_varifycode"),
...
void ResetDialog::on_sure_btn_clicked()
{
    ...
    http_mgr::get_instance()->post_httpreq(QUrl(gate_url_prefix+"/reset_pwd"),
