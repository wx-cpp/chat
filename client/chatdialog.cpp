    ...
    _state(ChatUIMode::ChatMode),_b_loading(false)
{
    ...
    clearAction->setIcon(QIcon(":/picture/close_transparent.png"));
    // 初始时不显示清除图标
    ...
    connect(ui->search_edit, &QLineEdit::textChanged, [clearAction](const QString &text) {
        if (!text.isEmpty()) {
            clearAction->setIcon(QIcon(":/picture/close_search.png"));
        } else {
            clearAction->setIcon(QIcon(":/picture/close_transparent.png")); // 文本为空时，切换回透明图标
        }
    ...
    connect(clearAction, &QAction::triggered, [this, clearAction]() {
        ...
        clearAction->setIcon(QIcon(":/picture/close_transparent.png")); // 清除文本后，切换回透明图标
